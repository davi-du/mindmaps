...
To support this goal, provide a well-structured response to the user's question in multiple paragraphs. 
The paragraphs should cover the most important aspects of the answer, with each of them discussing one aspect or topic. 
Each paragraph should have fewer than 10 sentences, and your response should have 2 paragraphs in total. 
...
Every paragraph must be annotated.
...
`,
  ...
  initialAskRag: (question: string): Prompt[] => {
    return [
      {
        role: 'system',
        content: `
